...
export class Event extends Entity {
  ...
  get totalConfirmedAttendies(): BigInt {
    let value = this.get("totalConfirmedAttendies");
    return value!.toBigInt();
  }

  set totalConfirmedAttendies(value: BigInt) {
    this.set("totalConfirmedAttendies", Value.fromBigInt(value));
  }
